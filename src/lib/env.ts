...
const schema = z.object({
  ...
  API_FOOTBALL_MAX_FIXTURES_PER_SCAN: z.coerce.number().default(36),
  API_FOOTBALL_ODDS_CONCURRENCY: z.coerce.number().default(10),
  API_FOOTBALL_CONTEXT_CONCURRENCY: z.coerce.number().default(8),
  API_FOOTBALL_MAX_SEED_CANDIDATES: z.coerce.number().default(120),
